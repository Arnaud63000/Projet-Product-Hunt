                    ...
                    <hr class="my-4">
                        <div class="populaire">
                            ...
                            <hr class="separateur">
                                ...
                                <div id="jvc-modal" data-toggle="modal" data-target="#jeuxvideomodal">
                                 <div class="images">
 ...
 <div class="modal fade" id="jeuxvideomodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content" id="modal">
      ...
      <img src="images/jeuxvideopointcom.png" id="logo"> <a href="http://www.jeuxvideo.com"> <h5 class="modal-title" id="exampleModalLabel">JEUXVIDEO.COM</h5> </a>
